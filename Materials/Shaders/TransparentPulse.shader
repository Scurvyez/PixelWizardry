Shader "Unlit/TransparentPulse"
{
    Properties 
	{
		_MainTex ("Main texture", 2D) = "white" {}
		_Color ("Color", Vector) = (1,1,1,1)
		_PulseSpeed ("Pulse Speed", Range(0.1, 50.0)) = 1.0
		_PulseAmplitude ("Pulse Amplitude", Range(0.1, 10.0)) = 1.0
	}
	...
	SubShader 
	{
		...
		Pass 
		{
			...
			fout frag(v2f inp)
			{
                ...
                finalColor.gb += finalColor.gb * pulseFactor * _PulseAmplitude;
